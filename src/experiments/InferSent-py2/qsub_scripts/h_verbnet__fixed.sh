...
#$ -o /export/c02/apoliak/recast-experiments/hypoths/emnlp/verbnet/hypoths__fixed/out.log 
#$ -e /export/c02/apoliak/recast-experiments/hypoths/emnlp/verbnet/hypoths__fixed/out.err 
...
OUTPUT_PATH=/export/c02/apoliak/recast-experiments/hypoths/emnlp-camera-ready/verbnet/hypoths__fixed/ 
