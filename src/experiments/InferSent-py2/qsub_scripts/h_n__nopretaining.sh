...
#$ -o /export/c02/apoliak/recast-experiments/hypoths/emnlp-camera-ready/n/hypoths__nopretaining/out.log 
#$ -e /export/c02/apoliak/recast-experiments/hypoths/emnlp-camera-ready/n/hypoths__nopretaining/out.err 

source /home/apoliak/.bashrc 
source activate mtie 

NLI_PATH=/export/c02/apoliak/recast-NLI-data/camera-ready-data/experiments/n/ 
OUTPUT_PATH=/export/c02/apoliak/recast-experiments/hypoths/emnlp-camera-ready/n/hypoths__nopretaining/ 
