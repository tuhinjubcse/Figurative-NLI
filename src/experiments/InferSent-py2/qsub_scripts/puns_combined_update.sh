...
#$ -e /export/c02/apoliak/recast-experiments/infersent/emnlp-camera-ready/puns/infersent_combined_update/out.err 
#$ -o /export/c02/apoliak/recast-experiments/infersent/emnlp-camera-ready/puns/infersent_combined_update/out.log 

source /home/apoliak/.bashrc 
source activate mtie 

#VARS 
NLI_PATH=/export/c02/apoliak/recast-NLI-data/camera-ready-data/experiments/puns/ 
OUTPUT_PATH=/export/c02/apoliak/recast-experiments/infersent/emnlp-camera-ready/puns/infersent_combined_update/ 
