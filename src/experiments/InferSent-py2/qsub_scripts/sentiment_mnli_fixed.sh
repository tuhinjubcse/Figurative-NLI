...
#$ -e /export/c02/apoliak/recast-experiments/infersent/emnlp-camera-ready/sentiment/infersent_mnli_fixed/out.err 
#$ -o /export/c02/apoliak/recast-experiments/infersent/emnlp-camera-ready/sentiment/infersent_mnli_fixed/out.log 
...
OUTPUT_PATH=/export/c02/apoliak/recast-experiments/infersent/emnlp-camera-ready/sentiment/infersent_mnli_fixed/ 
