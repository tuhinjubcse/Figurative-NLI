...
#$ -o /export/c02/apoliak/recast-experiments/hypoths/emnlp-camera-ready/puns/hypoths_combined_update/out.log 
#$ -e /export/c02/apoliak/recast-experiments/hypoths/emnlp-camera-ready/puns/hypoths_combined_update/out.err 
...
OUTPUT_PATH=/export/c02/apoliak/recast-experiments/hypoths/emnlp-camera-ready/puns/hypoths_combined_update/ 
