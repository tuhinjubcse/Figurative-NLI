...
#$ -o /export/c02/apoliak/recast-experiments/hypoths/emnlp-camera-ready/kg_relations/hypoths_mnli_fixed/out.log 
#$ -e /export/c02/apoliak/recast-experiments/hypoths/emnlp-camera-ready/kg_relations/hypoths_mnli_fixed/out.err 
...
OUTPUT_PATH=/export/c02/apoliak/recast-experiments/hypoths/emnlp-camera-ready/kg_relations/hypoths_mnli_fixed/ 
