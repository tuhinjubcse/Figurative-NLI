...
#$ -o /export/c02/apoliak/recast-experiments/hypoths/emnlp-camera-ready/verbnet/hypoths_combined_fixed/out.log 
#$ -e /export/c02/apoliak/recast-experiments/hypoths/emnlp-camera-ready/verbnet/hypoths_combined_fixed/out.err 
...
OUTPUT_PATH=/export/c02/apoliak/recast-experiments/hypoths/emnlp-camera-ready/verbnet/hypoths_combined_fixed/ 
