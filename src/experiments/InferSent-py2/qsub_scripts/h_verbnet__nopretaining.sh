...
#$ -o /export/c02/apoliak/recast-experiments/hypoths/emnlp-camera-ready/verbnet/hypoths__nopretaining/out.log 
#$ -e /export/c02/apoliak/recast-experiments/hypoths/emnlp-camera-ready/verbnet/hypoths__nopretaining/out.err 
...
OUTPUT_PATH=/export/c02/apoliak/recast-experiments/hypoths/emnlp-camera-ready/verbnet/hypoths__nopretaining/ 
